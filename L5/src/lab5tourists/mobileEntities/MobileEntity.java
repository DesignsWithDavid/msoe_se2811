...
import lab5tourists.Observer;
import lab5tourists.Subject;
import lab5tourists.Taggable;
...
public abstract class MobileEntity implements Taggable, Subject {
    ...
    public static final int TAG_DISTANCE_PIXELS = 25;
    ...
    /** A set of observers attached to the mobile entity*/
    ...
    public void notifyObservers(MobileEntity entity){
        MobileEntity[] mobileEntities = new MobileEntity[2];
        mobileEntities[0] = entity;
        mobileEntities[1] = this;
