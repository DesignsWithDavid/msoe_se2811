...
public class NetworkCanvasController {
    ...
    /**
     * Creates a random network that looks like a butterfly
     * @return network the butterfly network
     */
    private Layer createSurprise() {
        ...
        Layer layer3 = new FullyConnectedLayerDecorator(layer2, 1);
        Layer layer4 = new FullyConnectedLayerDecorator(layer3, 12);
        Layer layer5 = new FullyConnectedLayerDecorator(layer4, 6);
        return new FullyConnectedLayerDecorator(layer5, 3);
    }
